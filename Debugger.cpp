...
void Debugger::printMessage(GameBoy& zappyBoy)
{
...
void Debugger::setPreviousValues(GameBoy& zappyBoy)
{
	...
	prev_SP = zappyBoy.SP;
	prev_PC = zappyBoy.PC;
	prev_memoryAF = zappyBoy.memory[zappyBoy.AF];
	prev_memoryBC = zappyBoy.memory[zappyBoy.BC];
	prev_memoryDE = zappyBoy.memory[zappyBoy.DE];
	prev_memoryHL = zappyBoy.memory[zappyBoy.HL];
	prev_memorySP = zappyBoy.memory[zappyBoy.SP];
	prev_memoryNN = zappyBoy.memory[zappyBoy.immediate_16];
	prev_memoryFFXX = zappyBoy.memory[0xFF00 + zappyBoy.immediate_8];
	prev_memoryFFCC = zappyBoy.memory[0xFF00 + zappyBoy.C];
	prev_zFlag = zappyBoy.zFlag;
	prev_nFlag = zappyBoy.nFlag;
	prev_hFlag = zappyBoy.hFlag;
	prev_cFlag = zappyBoy.cFlag;
}
...
{
	if (prev_A != zappyBoy.A)
	{
		std::cout << "A: ";
		printVar8(prev_A);
		std::cout << " -> ";
		printVar8(zappyBoy.A);
		std::cout << "  ";
	}

	if (prev_F != zappyBoy.F)
	{
		std::cout << "F: ";
		printVar8(prev_F);
		std::cout << " -> ";
		printVar8(zappyBoy.F);
		std::cout << "  ";
	}

	if (prev_B != zappyBoy.B)
	{
		std::cout << "B: ";
		printVar8(prev_B);
		std::cout << " -> ";
		printVar8(zappyBoy.B);
		std::cout << "  ";
	}

	if (prev_C != zappyBoy.C)
	{
		std::cout << "C: ";
		printVar8(prev_C);
		std::cout << " -> ";
		printVar8(zappyBoy.C);
		std::cout << "  ";
	}

	if (prev_D != zappyBoy.D)
	{
		std::cout << "D: ";
		printVar8(prev_D);
		std::cout << " -> ";
		printVar8(zappyBoy.D);
		std::cout << "  ";
	}

	if (prev_E != zappyBoy.E)
	{
		std::cout << "E: ";
		printVar8(prev_E);
		std::cout << " -> ";
		printVar8(zappyBoy.E);
		std::cout << "  ";
	}

	if (prev_H != zappyBoy.H)
	{
		std::cout << "H: ";
		printVar8(prev_H);
		std::cout << " -> ";
		printVar8(zappyBoy.H);
		std::cout << "  ";
	}

	if (prev_L != zappyBoy.L)
	{
		std::cout << "L: ";
		printVar8(prev_L);
		std::cout << " -> ";
		printVar8(zappyBoy.L);
		std::cout << "  ";
	}

	if (prev_AF != zappyBoy.AF)
	{
		std::cout << "AF: ";
		printVar16(prev_AF);
		std::cout << " -> ";
		printVar16(zappyBoy.AF);
		std::cout << "  ";
	}

	if (prev_BC != zappyBoy.BC)
	{
		std::cout << "BC: ";
		printVar16(prev_BC);
		std::cout << " -> ";
		printVar16(zappyBoy.BC);
		std::cout << "  ";
	}

	if (prev_DE != zappyBoy.DE)
	{
		std::cout << "DE: ";
		printVar16(prev_DE);
		std::cout << " -> ";
		printVar16(zappyBoy.DE);
		std::cout << "  ";
	}

	if (prev_HL != zappyBoy.HL)
	{
		std::cout << "HL: ";
		printVar16(prev_HL);
		std::cout << " -> ";
		printVar16(zappyBoy.HL);
		std::cout << "  ";
	}

	if (prev_SP != zappyBoy.SP)
	{
		std::cout << "SP: ";
		printVar16(prev_SP);
		std::cout << " -> ";
		printVar16(zappyBoy.SP);
		std::cout << "  ";
	}

	if (prev_memoryAF != zappyBoy.memory[zappyBoy.AF])
	{
		std::cout << "(";
		printVar16(zappyBoy.AF);
		std::cout << "): ";
		...
		std::cout << " -> ";
		printVar8(zappyBoy.memory[zappyBoy.AF]);
		std::cout << "  ";
	}

	if (prev_memoryBC != zappyBoy.memory[zappyBoy.BC])
	{
		std::cout << "(";
		printVar16(zappyBoy.BC);
		std::cout << "): ";
		...
		std::cout << " -> ";
		printVar8(zappyBoy.memory[zappyBoy.BC]);
		std::cout << "  ";
	}

	if (prev_memoryDE != zappyBoy.memory[zappyBoy.DE])
	{
		std::cout << "(";
		printVar16(zappyBoy.DE);
		std::cout << "): ";
		...
		std::cout << " -> ";
		printVar8(zappyBoy.memory[zappyBoy.DE]);
		std::cout << "  ";
	}

	if (prev_memoryHL != zappyBoy.memory[zappyBoy.HL])
	{
		std::cout << "(";
		printVar16(zappyBoy.HL);
		std::cout << "): ";
		...
		std::cout << " -> ";
		printVar8(zappyBoy.memory[zappyBoy.HL]);
		std::cout << "  ";
	}

	if (prev_memorySP != zappyBoy.memory[zappyBoy.SP])
	{
		std::cout << "(";
		printVar16(zappyBoy.SP);
		std::cout << "): ";
		...
		std::cout << " -> ";
		printVar8(zappyBoy.memory[zappyBoy.SP]);
		std::cout << "  ";
	}

	if (prev_memoryNN != zappyBoy.memory[zappyBoy.immediate_16])
	{
		std::cout << "(";
		printVar16(zappyBoy.immediate_16);
		std::cout << "): ";
		printVar8(prev_memoryNN);
		std::cout << " -> ";
		printVar8(zappyBoy.memory[zappyBoy.immediate_16]);
		std::cout << "  ";
	}

	if (prev_memoryFFXX != zappyBoy.memory[0xFF00 + zappyBoy.immediate_8])
	{
		std::cout << "(";
		printVar16(0xFF00 + zappyBoy.immediate_8);
		std::cout << "): ";
		printVar8(zappyBoy.memory[prev_memoryFFXX]);
		std::cout << " -> ";
		printVar8(zappyBoy.memory[0xFF00 + zappyBoy.immediate_8]);
		std::cout << "  ";
	}

	if (prev_memoryFFCC != zappyBoy.memory[0xFF00 + zappyBoy.C])
	{
		std::cout << "(";
		printVar16(0xFF00 + zappyBoy.C);
		std::cout << "): ";
		printVar8(prev_memoryFFCC);
		std::cout << " -> ";
		printVar8(zappyBoy.memory[0xFF00 + zappyBoy.C]);
		std::cout << "  ";
	}

	if (prev_zFlag != zappyBoy.zFlag)
	{
		std::cout << "zFlag: ";
		printVar8(prev_zFlag);
		std::cout << " -> ";
		printVar8(zappyBoy.zFlag);
		std::cout << "  ";
	}

	if (prev_nFlag != zappyBoy.nFlag)
	{
		std::cout << "nFlag: ";
		printVar8(prev_nFlag);
		std::cout << " -> ";
		printVar8(zappyBoy.nFlag);
		std::cout << "  ";
	}

	if (prev_hFlag != zappyBoy.hFlag)
	{
		std::cout << "hFlag: ";
		printVar8(prev_hFlag);
		std::cout << " -> ";
		printVar8(zappyBoy.hFlag);
		std::cout << "  ";
	}

	if (prev_cFlag != zappyBoy.cFlag)
	{
		std::cout << "cFlag: ";
		printVar8(prev_cFlag);
		std::cout << " -> ";
		printVar8(zappyBoy.cFlag);
		std::cout << "  ";
	}
